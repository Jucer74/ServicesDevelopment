...
namespace Pricat.Api.Controllers
{
    ...
    public class CategoriesController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<IActionResult> AddCategori([FromBody] Category categori)
        {
            if (categori == null)
            {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> UpdateCategori(int id, [FromBody] Category categori)
        {
            if (id != categori.Id)
            {
