...
namespace Pricat.Api.Middleware
{
    ...
    public static class ExceptionMiddlewareExtensions
    {
        ...
        public static ErrorDetails ConstructErrorMessages(this ActionContext context)
        {
            ...
            var deserializationErrorKeywords = new[] { "invalid start", "unexpected character", "invalid character" };
            var hasDeserializationError = errors.Any(e => deserializationErrorKeywords.Any(keyword =>
                e.Contains(keyword, StringComparison.OrdinalIgnoreCase)));
