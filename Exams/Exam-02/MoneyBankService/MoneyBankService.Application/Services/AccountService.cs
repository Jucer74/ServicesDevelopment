...
public class AccountService : IAccountService
{
    ...
    public async Task<Account> CreateAccount(Account account)
    {
        ...
        if (accounts.Any())
        {
            throw new BadRequestException($"Account numero [{account.AccountNumber}] ya existe");
        }
    ...
    public async Task<Account> UpdateAccount(int id, Account account)
    {
        if (id != account.Id)
        {
            throw new BadRequestException($"Id [{id}] es diferente de Account.Id [{account.Id}]");
        }
    ...
    public async Task Deposit(int id, TransactionDto transactionDto)
    {
        ...
        {
            throw new BadRequestException($"Account numero [{transactionDto.AccountNumber}] es diferente de Account.AccountNumber [{account.AccountNumber}]");
        }
    ...
    public async Task Withdraw(int id, TransactionDto transactionDto)
    {
        ...
        {
            throw new BadRequestException($"Id [{id}] es diferente de Transaction.Id [{transactionDto.Id}]");
        }
    ...
    public async Task<IEnumerable<Account>> FindAccountsByAccountNumber(string accountNumber)
    {
        ...
        throw new NotFoundException($"Accounts no encontrado");
    }
}