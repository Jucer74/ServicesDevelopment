...
export function CategoriaList() {
  const baseUrl = "https://localhost:5001/api/PizzeriaCategoria";
  const baseUrlCategoria = "https://localhost:5001/api/Pizzerias";
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get(`${baseUrlCategoria}/${pizzaId}/Category`);
...
return (
      ...
      <ModalBody>
        <Form>
          ...
          <Form.Group>
            <Form.Label>PizzasId:</Form.Label>
            <Form.Control type="text" id="txtPizzassid" name="PizzasId" readOnly value={currentPizzeria.id} />
          </Form.Group>
          <Form.Group>
            <Form.Label>Nombre:</Form.Label>
            <Form.Control type="text" id="txtNombree" name="nombre" required isInvalid={!currentPizzeria.Categoriaa && validationError !== ''} onChange={handleChange} value={currentPizzeria.nombre} />
            <Form.Control.Feedback type="invalid">{validationError}</Form.Control.Feedback>
          </Form.Group>
          <Form.Group>
            <Form.Label>Tamaño:</Form.Label>
            <Form.Control type="text" id="txtTamañoo" name="tamaño" required isInvalid={!currentPizzeria.Categoriaa && validationError !== ''} onChange={handleChange} value={currentPizzeria.tamaño} />
            <Form.Control.Feedback type="invalid">{validationError}</Form.Control.Feedback>
          </Form.Group>
          <Form.Group>
            <Form.Label>Precio:</Form.Label>
            <Form.Control type="text" id="txtPrecioo" name="precio" required isInvalid={!currentPizzeria.Categoriaa && validationError !== ''} onChange={handleChange} value={currentPizzeria.precio} />
            <Form.Control.Feedback type="invalid">{validationError}</Form.Control.Feedback>
          </Form.Group>
        </Form>
      </ModalBody>
    ...
    <Modal isOpen={showModalDetails}>
      ...
      <ModalBody>
        <Form>
          ...
          <Form.Group>
            <Form.Label>PizzasId:</Form.Label>
            <Form.Control type="text" id="txtPizzasid" name="pizzasId" readOnly value={currentPizzeria.id} />
          </Form.Group>
          <Form.Group>
            <Form.Label>Nombre:</Form.Label>
            <Form.Control type="text" id="txtNombree" name="nombre" readOnly value={currentPizzeria.nombre} />
          </Form.Group>
          <Form.Group>
            <Form.Label>Tamaño:</Form.Label>
            <Form.Control type="text" id="txtTamañoo" name="tamaño" readOnly value={currentPizzeria.tamaño} />
          </Form.Group>
          <Form.Group>
            <Form.Label>Precio:</Form.Label>
            <Form.Control type="text" id="txtPrecioo" name="precio" readOnly value={currentPizzeria.precio} />
          </Form.Group>
        </Form>
      </ModalBody>
      <ModalFooter>
      ...
      <ModalBody>
        <Form>
          <Form.Group>
            ...
            <Form.Label><b>PizzasId:</b></Form.Label>
            <Form.Label>{currentPizzeria.id}</Form.Label><br />
