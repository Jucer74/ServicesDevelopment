...
public class CreditCardController : ControllerBase
{
    ...
    // POST method
    [HttpPost]
    public async Task<IActionResult> PostCreditCardData(CreditCardDto creditCardDto)
    {
        var validateResult = await _creditCardService.Validate(creditCardDto.CreditCardNumber);
        var result = _creditCardService.Result;
    ...
    public async Task<IActionResult> PutCreditCardData(string creditcardNumber, CreditCardDto creditCardDto)
    {
        var validateResult = await _creditCardService.Validate(creditCardDto.CreditCardNumber);
        var result = _creditCardService.Result;
    ...
    // DELETE method
    [HttpDelete("{creditcardNumber}")]
    public async Task<IActionResult> DeleteCreditCardData(string creditcardNumber)
    {
        var validateResult = await _creditCardService.Validate(creditcardNumber);
        var result = _creditCardService.Result;
