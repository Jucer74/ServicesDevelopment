...
INSERT INTO `arepasdb`.`orders` ( `CustomerId`, `DeliveryFullName`, `DeliveryAddress`, `DeliveryPhoneNumber`, `TotalPrice`, `Notes`) VALUES (2,'Sofia Herrera','Avenida 3N # 8-56, Barrio Granada','311-234-5678',19000,'Pilas con el Perro que es Bravo');
...
INSERT INTO `arepasdb`.`orders` ( `CustomerId`, `DeliveryFullName`, `DeliveryAddress`, `DeliveryPhoneNumber`, `TotalPrice`, `Notes`) VALUES (5,'Sebastian Silva','Avenida 6N # 9-87, Barrio El PeÃ±Ã³n','314-567-8901',12000,null);
/*******************
*-- OrderDetails --*
*******************/
